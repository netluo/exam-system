...
if __name__ == "__main__":
    ...
    main_logic.qid_list = random.sample(range(mgr.qid_range[1][0], mgr.qid_range[1][1]), 3) + \
                          random.sample(range(mgr.qid_range[2][0], mgr.qid_range[2][1]), 3) + \
                          random.sample(range(mgr.qid_range[3][0], mgr.qid_range[3][1]), 3)
